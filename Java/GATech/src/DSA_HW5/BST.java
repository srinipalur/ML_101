...
public class BST<T extends Comparable<? super T>> {
    ...
    private BSTNode<T> addRecur(BSTNode<T> curr, T data) {
        if(curr == null) {
            ...
            curr.setRight(addRecur(curr.getRight(), data));
        else if(curr.getData().compareTo(data) > 0)
            curr.setLeft(addRecur(curr.getLeft(), data));
        return curr;
    }
    ...
    private BSTNode<T> recurRemove(BSTNode<T> curr, T data, BSTNode<T> dummy) {
        if(curr == null)
